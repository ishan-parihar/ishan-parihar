...
DATA = [
    # --- engines -----------------------------------------------------------
    ("igs-rust", "engine", 27738, 231, 1, 2, 198, 15, 96, 2, 500, 93, 11, "mcp", 0, 0, 432, 1, 1),
    ("social-forge", "engine", 77836, 257, 3, 2, 479, 2, 96, 5, 500, 328, 10, "mcp", 0, 0, 557, 1, 1),
    ...
    ("tdg-rust", "engine", 47797, 626, 1, 1, 146, 10, 55, 3, 268, 50, 11, "mcp", 0, 0, 227, 1, 1),
    ("slideforge-rust", "engine", 35631, 185, 2, 1, 203, 6, 43, 3, 74, 20, 10, "mcp", 0, 1, 346, 1, 1),
